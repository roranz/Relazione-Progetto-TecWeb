...
%Necessario per la defizione dei margini e della struttura della pagina
...
\begin{document}
{
    ...
    \input{2_Analisi}
    \newpage
    \input{3_Organizzazione_Interna}
    \newpage
    \input{4_Tecnologie}
    \newpage
    \input{5_Progettazione}
    \newpage
    \input{6_Base_di_Dati}
    \newpage
    \input{7_Costruzione}
    \newpage
    \input{8_Strutturazione}
    \newpage
    \input{9_Accessibilità}
    \newpage
    \input{10_Usabilità}
    \newpage
    \input{11_Conclusione}
    \newpage
